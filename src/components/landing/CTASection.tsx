    ...
    <section id="cadastro" className="py-24 md:py-32 px-6 md:px-10">
      <div className="max-w-[1240px] mx-auto relative rounded-[2.5rem] bg-ink text-paper p-12 md:p-20 overflow-hidden">
        ...
        <div className="relative max-w-3xl">
          ...
          <h2 className="font-display font-bold text-5xl md:text-7xl leading-[0.95] tracking-[-0.04em] text-balance">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10">
            <Button variant="editorial" size="editorial" className="!bg-paper !text-ink hover:!bg-electric hover:!text-paper">
              Sou estudante
            </Button>
            <Button variant="editorialOutline" size="editorial" className="!border-paper/30 !text-paper hover:!bg-hotpink hover:!border-hotpink hover:!text-paper">
              Quero ser mentor
            </Button>
          </div>
        </div>
